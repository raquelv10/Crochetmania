document.addEventListener("DOMContentLoaded", () => {
    ...
    //Creamos el título del aside y lo insertamos.
    h2.appendChild(titulo);
    div_content_aside.appendChild(h2);

    //Creamos los enlaces vacíos y los insertamos
    for (let i = 0; i < 6; i++) {
    ...
    //Creamos las URL correspondientes a cada enlace "a" y el texto que debe aparecer
